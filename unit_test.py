...
class TestAssertEqual(unittest.TestCase):
	...
	def test_func_1(self):
		...
		for test_case_i in test_case:
			...
			main.startGame(tic_tac_toe)
			result = main.run_code(tic_tac_toe, test_case_i)
	...
	def test_func_2(self):
		...
		# test_case = [[1,2,2,3,5,4,6,8,7,9], [1,2,4,6,7],[1,2,2,3,5,4,6,8,7,9], [1,12,2,3,5,4,6,8,7,9],
		# 	[1,12,2,3,5,5,4,6,8,7,9]]
		test_case = [[1,2,2,3,5,4,6,8,7,9],[1,2,2,3,5,4,6,8,7,9], [1,12,2,3,5,4,6,8,7,9],
			[1,12,2,3,5,5,4,6,8,7,9]]
		...
		# result = main.run_code(tic_tac_toe, test_case)
		# print("Result", result)
